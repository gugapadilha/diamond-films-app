...
class FilmsActivity : AppCompatActivity() {
    ...
    override fun onResume() {
        ...
        listFilmes.add(Filme("Caça Invísivel", "Suspense", "1hr27mim", "https://i.ytimg.com/vi/vN7xlP7rZcE/maxresdefault.jpg"))
        ...
        listFilmes.add(Filme("O Esquadrao Suicida", "Ação", "3 horas", "https://observatoriodocinema.uol.com.br/wp-content/uploads/2021/07/o-esquadrao-suicida-1200x900-2.jpg"))
